...
def test_eblabsorptionmodel():
    ...
    IC = InverseCompton(BPL,
                        seed_photon_fields=['CMB'],
                        Eemin=10 * u.GeV)
#   Test if the EBL absorption at z = 0 changes the inverse compton component of a broken power law
    assert_allclose(IC.sed(e).value, IC.sed(e).value * EBL_zero.transmission(e), rtol=1e-1)
